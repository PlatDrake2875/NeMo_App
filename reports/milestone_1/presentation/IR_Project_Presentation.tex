...
\begin{enumerate}
    \item \textbf{Stage 1 -- COMPLETED (Nov 2025)}:
        ...
        \end{itemize}
    \item \textbf{Stage 2 -- Planned}: Fully Integrate ColBERT, HippoRAG and Benchmark evaluation (MS MARCO, NQ) on everything so far
    \item \textbf{Stage 3 -- Final}: Comparative analysis 
\end{enumerate}
