...
\begin{itemize}
    \item ColBERT vs FAISS comparison
...
\textbf{Approach}: Build working baseline, then add comparison methods
...
%==============================================================================
% Slide 4: ColBERT -- Planned for Stage 2
%==============================================================================
\begin{frame}{ColBERT -- Late Interaction Retrieval \textcolor{red}{[Stage 2]}}
...
\textbf{Current}: Using standard dense embeddings with cosine similarity
\end{columns}

\end{frame}

%==============================================================================
% Slide 5: FAISS -- Planned for Stage 2
%==============================================================================
...
%==============================================================================
\begin{frame}{Evaluation Metrics \textcolor{red}{[Stage 3]}}

\begin{columns}
\column{0.5\textwidth}
\textbf{Retrieval Metrics (Planned)}:
\begin{itemize}
...
\textbf{Generation Metrics (Planned)}:
\begin{itemize}
    \item BLEU, ROUGE-L
    \item BERTScore
\end{itemize}
...
\column{0.5\textwidth}
\textbf{Efficiency Metrics (Planned)}:
\begin{itemize}
...
\begin{enumerate}
    \item \textbf{Stage 1 -- COMPLETED (Nov 2025)}:
        \begin{itemize}
            ...
            \item pgvector \& Qdrant integration
            \item NeMo Guardrails implementation
            \item Full-stack deployment (React + FastAPI + vLLM)
        \end{itemize}
    \item \textbf{Stage 2 -- Planned}: Add ColBERT, FAISS, sparse embeddings
